...
run_learn_individual(upenn_proteomics_file, 'Unnamed: 0', upenn_traits_file, 'MaxQuant ID', "Group")
...
run_learn_individual(mayo_proteomics_file, 'Unnamed: 0', mayo_traits_file, 'SampleID', "Diagnosis")
...
run_learn_individual(csf_proteomics_file, 'Unnamed: 0', csf_traits_file, 'SampleID', "Group")
...
run_learn_individual(csf_proteomics_file, 'Unnamed: 0', csf_traits_file, 'batch.channel', "ClinicalGroup")
...
run_learn_individual(consensus_proteomics_file, 'Unnamed: 0', consensus_traits_file, 'Unnamed: 0', "Group")
